                        ...
                        {foreach $cats as $cat name="category"}
                            ...
                            {if $smarty.foreach.category.last}
                                <li class="breadcrumb-item">
                                   ...
                                   {assign var="hrefProd" value="/product/{$hrefCur}/{$rsProduct['productId']}/"}
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header  px-1 py-1 px-sm-2 py-sm-2 px-md-3 py-md-3">
                                        <h5 class="modal-title heading col-nav "
                                            id="exampleModalLabel">{$rsProduct['name']}</h5>
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="d-flex flex-row align-items-center">
                            <a id="addwishlist_{$rsProduct['productId']}" href="#"
                               onClick='addToBookmark({$rsProduct['productId']},
                                 "/product/{$hrefCur}/{$rsProduct['productId']}/",0);return false; ' ;
                               alt='Удалить из закладок'
                               class="me-1 me-sm-2 me-lg-3 me-xl-4  ms-1 nav-link
                               {if ! $rsProduct['bookmarks']} hideme"{else}"{/if}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <a id="removewishlist_{$rsProduct['productId']}" href="#"
                               onClick='addToBookmark({$rsProduct['productId']},
                                "/product/{$hrefCur}/{$rsProduct['productId']}/",1);return false; ' ;
                            ...
                            <a id="addcart_{$rsProduct['productId']}" href="#"
                               onClick="addToCart({$rsProduct['productId']},0);
                            ...
                            <a id="removecart_{$rsProduct['productId']}" href="#"
                               onClick='addToCart({$rsProduct['productId']},1,
                                            "{$rsProduct['image']}",
                                            "{$rsProduct['name']}",
