                        ...
                        {if $layout == 'rows'}
                            ...
                            {foreach $bookmarks as $itemProd name=prodCildren}
                                <div class="row mb-1 mx-0 mx-sm-1" id="wishlist_{$itemProd['product_id']}">
                                    ...
                                    <div class="col-7 col-sm-8  px-0">
                                        <a href="{$itemProd['link']}" class="btn mt-auto bg-nav-opposite col-nav-opposite nv-hover h-100  w-100 
                                    ...
                                    <div
                                        ...
                                        <a id="addcart_{$itemProd['product_id']}" href="#"
                                            onClick='addToCart({$itemProd['product_id']},"{$itemProd['link']}",0) ; return false;'
                                            alt='Добавить в корзину' class="me-1  mb-1 nav-link {if ! $itemProd['inCart']} hideme" {else}"{/if}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                        ...
                                        <a id="removecart_{$itemProd['product_id']}" href="#"
                                            onClick='addToCart({$itemProd['product_id']},"{$itemProd['link']}",1)' ; return false;
                                            alt='Добавить в корзину' class="me-1  mb-1 nav-link {if  $itemProd['inCart']} hideme" {else}"{/if}>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                        ...
                                        <div class="card h-100 bg-nav-btn">
                                            ...
                                            <div class="card-body px-1 py-1">
                                                ...
                                                <div class="d-flex flex-row align-items-center justify-content-center ">
                                                    <a id="addwishlist_{$itemProd['product_id']}" href="#"
                                                            onClick='addToBookmark({$itemProd['product_id']},"{$itemProd['link']}",0); return false;' {*document.location.reload();*}
                                                            alt='Удалить из закладок'
                                                    ...
                                                    <a id="addcart_{$itemProd['product_id']}" href="#"
                                                        onClick='addToCart({$itemProd['product_id']},"{$itemProd['link']}",0)' ;
                                                    ...
                                                    <a id="removecart_{$itemProd['product_id']}" href="#"
                                                        onClick='addToCart({$itemProd['product_id']},"{$itemProd['link']}",1)' ;
                                                        return false; alt='Добавить в корзину'
                                                        class="me-1  mb-1 nav-link {if  $itemProd['inCart']} hideme" {else}"{/if}>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
