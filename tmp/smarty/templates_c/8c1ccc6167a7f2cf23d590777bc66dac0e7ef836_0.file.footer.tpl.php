<?php
/* Smarty version 4.2.1, created on 2023-02-28 17:01:22
  from 'D:\xampp\htdocs\beautic.local\views\default\footer.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.1',
  'unifunc' => 'content_63fe2552b78793_89080244',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8c1ccc6167a7f2cf23d590777bc66dac0e7ef836' => 
    array (
      0 => 'D:\\xampp\\htdocs\\beautic.local\\views\\default\\footer.tpl',
      1 => 1677600078,
      2 => 'file',
    ),
  ),
...
function content_63fe2552b78793_89080244 (Smarty_Internal_Template $_smarty_tpl) {
?><!--            </div>
        </div>
    </div>
</div>  -->
        ...
        <footer  id="footer" class="footer mt-auto fixed-bottom" >             <div class="container">
                    <div class="row">
                        <div class="col-12 text-center my-1">

                            <?php if ((isset($_smarty_tpl->tpl_vars['arUser']->value))) {?> 
                                <a href="/user/" class="btn btn-outline-light"
                                    data-bs-toggle="tooltip" data-bs-placement="top" title="Личный кабинет: <?php echo $_smarty_tpl->tpl_vars['arUser']->value['name'];?>
"
                            ...
                            <?php if ((isset($_smarty_tpl->tpl_vars['arUser']->value))) {?>
                                ...
                                <a href="/user/bookmarks/" class="btn btn-outline-light" data-bs-toggle="tooltip"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                        class="bi bi-heart-fill <?php if (!$_smarty_tpl->tpl_vars['wishlistNotNull']->value) {?>hideme<?php }?>" viewBox="0 0 16 16"
                                        id="userWishlistFullf">
                                        <path fill-rule="evenodd"
                                            d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z" />
                                    </svg>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                        class="bi bi-heart <?php if ($_smarty_tpl->tpl_vars['wishlistNotNull']->value) {?>hideme<?php }?>" viewBox="0 0 16 16"
                            ...
                            <a href="#" class="btn btn-outline-light" data-bs-toggle="tooltip"
                                data-bs-placement="top" title="Контакты" data-bs-custom-class="custom-tooltip">
        ...
        <?php echo '<script'; ?>
 type="text/javascript" src="/js/bootstrap.bundle.min.js"><?php echo '</script'; ?>
>
    </body>
</html><?php }
}
