<?php
/* Smarty version 4.2.1, created on 2023-01-20 13:01:21
  from 'D:\xampp\htdocs\beautic.local\views\default\updatepass.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.1',
  'unifunc' => 'content_63ca829123d562_67989855',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd79d478df1eb65d21bcd090b7014c8f72090d8f7' => 
    array (
      0 => 'D:\\xampp\\htdocs\\beautic.local\\views\\default\\updatepass.tpl',
      1 => 1674216076,
      2 => 'file',
    ),
  ),
...
function content_63ca829123d562_67989855 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="container my-auto px-0 bg-nav h-100 mb-1">
    ...
    <div class="row ">
        ...
        <?php if ($_smarty_tpl->tpl_vars['userId']->value) {?>
            <form method="post" action="/restuser/changepassup/">
            <h5 class="ms-2 mb-1 mb-sm-2 mb-lg-4 text-break heading col-nav "> Логин: <?php echo $_smarty_tpl->tpl_vars['login']->value;?>
 </h5> 
                                <input type="text" class="d-none" name="userId" value="<?php echo $_smarty_tpl->tpl_vars['userId']->value;?>
">
            ...
            <?php } else { ?>
                <p class="ms-1 mb-1">Что-то пошло не так. Запросите смену пароля ещё раз</p>
            <?php }?>  
        </div>
